...
<p class="tip">Using `v-if` and `v-for` together is **not recommended**. See the [style guide](/style-guide/#Avoid-v-if-with-v-for-essential) for further information.</p>
