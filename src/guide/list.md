...
<p class="tip">Note that it's **not** recommended to use `v-if` and `v-for` together. Refer to [style guide](/style-guide/#Avoid-v-if-with-v-for-essential) for details.</p>
